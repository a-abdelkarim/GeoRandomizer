...
class GeoRandomizer:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'GeoRandomizer_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Geo Randomizer')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('GeoRandomizer', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/geo_randomizer/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u''),
            callback=self.run,
